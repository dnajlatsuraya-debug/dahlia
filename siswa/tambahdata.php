            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-4 text-gray-800">Tambahan Data Siswa SMKN 1 CIOMAS</h1>
                     ...
                     <label for="inputNISNrd5" class="form-label">NISN</label>
                     <input type="NISN" id="inputNISNrd5" class="form-control" aria-describedby="NISNHelpBlock">
                     <div id="NISNHelpBlock" class="form-text">

                     <label for="inputEMAILrd5" class="form-label">EMAIL</label>
                     <input type="EMAIL" id="inputEMAILrd5" class="form-control" aria-describedby="EMAILHelpBlock">
